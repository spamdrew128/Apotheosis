...
#define INNER_ATTACKS { \
   S(131, -428), S(21, -133), S(-3, -50), S(-5, -18), S(-3, 1), S(-19, 0), \
}

#define OUTER_ATTACKS { \
   S(131, -428), S(21, -133), S(-3, -50), S(-5, -18), S(-3, 1), S(-19, 0), \
}

#define INNER_DEFENSE { \
   S(131, -428), S(21, -133), S(-3, -50), S(-5, -18), S(-3, 1), \
}

#define OUTER_DEFENSE { \
   S(131, -428), S(21, -133), S(-3, -50), S(-5, -18), S(-3, 1), \
}
