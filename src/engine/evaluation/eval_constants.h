...
#define PAWN_THREAT_ON_KNIGHT S(0, 0)
#define PAWN_THREAT_ON_BISHOP S(0, 0)
#define PAWN_THREAT_ON_ROOK S(0, 0)
#define PAWN_THREAT_ON_QUEEN S(0, 0)

#define KNIGHT_THREAT_ON_BISHOP S(0, 0)
#define KNIGHT_THREAT_ON_ROOK S(0, 0)
#define KNIGHT_THREAT_ON_QUEEN S(0, 0)

#define BISHOP_THREAT_ON_KNIGHT S(0, 0)
#define BISHOP_THREAT_ON_ROOK S(0, 0)
#define BISHOP_THREAT_ON_QUEEN S(0, 0)

#define ROOK_THREAT_ON_QUEEN S(0, 0)
