...
#define KNIGHT_MOBILITY { \
   S(22, -23), S(148, 105), S(161, 134), S(175, 155), S(193, 155), S(195, 166), S(206, 167), S(219, 168), S(229, 158), \
}

#define BISHOP_MOBILITY { \
   S(125, 55), S(100, 95), S(126, 123), S(145, 142), S(162, 146), S(171, 158), S(176, 166), S(182, 168), S(185, 172), S(189, 174), S(193, 173), S(213, 167), S(187, 184), S(198, 171), \
}

#define ROOK_MOBILITY { \
   S(4, 1), S(117, 121), S(176, 189), S(183, 212), S(189, 220), S(192, 242), S(196, 251), S(194, 256), S(197, 258), S(205, 261), S(214, 261), S(221, 262), S(225, 264), S(236, 257), S(230, 253), \
}

#define QUEEN_MOBILITY { \
   S(0, 0), S(0, 0), S(0, 1), S(49, 27), S(255, 110), S(315, 222), S(323, 301), S(330, 318), S(330, 343), S(334, 355), S(336, 370), S(340, 379), S(343, 380), S(348, 381), S(351, 381), S(357, 375), S(360, 368), S(361, 367), S(365, 358), S(369, 351), S(364, 347), S(366, 332), S(369, 330), S(362, 323), S(346, 320), S(332, 314), S(265, 302), S(233, 290), \
}
